...
The WordPress Transifex Workflow is maintained by [Fx Bénard](http://twitter.com/fxbenard/), but is originally forked from a work of [Tom McFarlin](https://github.com/tommcfarlin/WordPress-Plugin-Boilerplate/), but is constantly under development thanks to the contributions from the many WordPress developers throughout the world.
