...
Contributors: tommcfarlin, remicorson
Donate link: http://wp-translations.org/
Tags: testing, internationalization
...
Create a perfect workflow for WordPress project internationalization with Transifex.

== Description ==

The WordPress Transifex Workflow serves as a foundation and aims to provide a clear and consistent guide for integrating a GitHub project with Transifex. And so create a perfect workflow for WordPress project internationalization.

== Installation ==

1. Upload `tx-workflow.php` to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Locate the menu item that reads *TX Workflow*
4. Click on *Activate*

This will activate the WordPress Tx Workflow. Because the plugin has no real functionality, only a new menu item will be added to the *Plugins* menu.

== Changelog ==

= 3.6 =
* Initial release of WordPress Transifex Workflow based on everything below
...
* Official Release of [WordPress Plugin Boilerplate] (https://github.com/tommcfarlin/WordPress-Plugin-Boilerplate)
